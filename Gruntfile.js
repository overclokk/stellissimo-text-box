module.exports = function(grunt) {
    ...
    grunt.initConfig({
        ...
        "github-release": { // https://github.com/dolbyzerr/grunt-github-releaser
            options: {
                repository: 'overclokk/stellissimo-text-box', // Path to repository
                release: {
                    name: '<%= pkg.name %> <%= pkg.version %>',
                    body: '## New release of <%= pkg.name %> <%= pkg.version %> \nSee the **[changelog](https://github.com/overclokk/stellissimo-text-box#changelog)**',
                }
            },
            files: {
        ...
        copy: { // https://github.com/gruntjs/grunt-contrib-copy
            tosvn: {
                ...
                dest: 'E:/Dropbox/svn-wordpress/stellissimo-text-box/trunk/',
                filter: 'isFile',
            },
            totag: {
                expand: true,
                ...
                dest: 'E:/Dropbox/svn-wordpress/stellissimo-text-box/tags/<%= pkg.version %>/',
                filter: 'isFile',
            },
            /**
